<template>
    ...
    <section>
        ...
        <jet-dialog-modal :show="openModal" @close="openModal = false">
            <template #title>
                <p class="text-black">단어장 만들기</p>
            </template>

            <template #content>
                <div class="relative w-full mb-3 mt-8">
                    <label class="block uppercase text-black
    ...
    methods : {
        ...
        save_voca() {
            ...
            if(check === false)
                return
            const data = {
                title : this.create_voca.title,
                message : this.create_voca.message,
            }
